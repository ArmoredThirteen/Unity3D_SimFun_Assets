        ...
        public void FirstPrint()
        {
            ...
            for (int x = 0; x < inGenMap.sizeX; x++)
            {
                for (int y = 0; y < inGenMap.sizeY; y++)
                {
                    ...
                    solidCorner.transform.localPosition = new Vector3 (wallLocX, wallLocY);
                    ...
                    objMap[x, y, 0].transform.localPosition = new Vector3 (wallLocX, wallLocY + spacing);
                    objMap[x, y, 1].transform.localPosition = new Vector3 (wallLocX + spacing, wallLocY);
                }
            }
